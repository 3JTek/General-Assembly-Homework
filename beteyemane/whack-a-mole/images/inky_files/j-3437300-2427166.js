...
(function(){
    ...
    (function() {
    var p = "3437300", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_3437300||'',
    GUID:window.ftGUID_3437300||'99999999999',
    confID:window.ftConfID_3437300||'0',
    ftReturn: window.ftReturn_3437300||'',
    keyword:window.ftKeyword_3437300||'',
    ftId:window.ftId_3437300||'',
    imp:window.ftImp3437300,
    ftImpId:window.ftImp3437300 && window.ftImp3437300.impID || '',
    campaignID:'99535',
    cID:'95498',
    pID:'3437300',
    creativeID:'2427166',
    exttrack:["https://ad.doubleclick.net/ddm/trackimp/N572608.286450AMNET/B21816604.231342665;dc_trk_aid=429308442;dc_trk_cid=107350230;ord="],
    extscript:[""],
    clickTags: ["http://servedby.flashtalking.com/click/6/99535;3437300;2427166;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=https://ad.doubleclick.net/ddm/trackclk/N572608.286450AMNET/B21816604.231342665;dc_trk_aid=429308442;dc_trk_cid=107350230;dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;tfua=?https://www.xbox.com/en-GB","http://servedby.flashtalking.com/click/6/99535;3437300;2427166;212;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=https://ad.doubleclick.net/ddm/trackclk/N572608.286450AMNET/B21816604.231342665;dc_trk_aid=429308442;dc_trk_cid=107350230;dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;tfua=?https://www.xbox.com/en-GB"],
    placementDescription:'MSFTprogrammaticDBMOpenExchange300x600DMPUBANDTDYNBTWNATPFTOMPQ2PlatformDMPUPI1PNTXHVGGamersNANAConversion1P177',
    width:300,
    height:600,
    ...
    divID:'ftdiv3437300',
    phID:'ftpos3437300',
    frameID:'ftframe3437300',
    expID:'ftexpframe3437300',
    altImgID:'ftalt3437300',
    altText:'Click here',
    altImgTarget:'_blank',
    altimghref:'http://servedby.flashtalking.com/click/6/99535;3437300;2427166;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=https://ad.doubleclick.net/ddm/trackclk/N572608.286450AMNET/B21816604.231342665;dc_trk_aid=429308442;dc_trk_cid=107350230;dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;tfua=?https://www.xbox.com/en-GB',
    altImg:'http://servedby.flashtalking.com/imp/6/99535;3437300;204;gif;Amnet;MSFTprogrammaticDBMOpenExchange300x600DMPUBANDTDYNBTWNATPFTOMPQ2PlatformDMPUPI1PNTXHVGGamersNANAConversion1P177/?',
    viewableImpressionURL:'http://servedby.flashtalking.com/imp/6/99535;3437300;271;pixel;Amnet;MSFTprogrammaticDBMOpenExchange300x600DMPUBANDTDYNBTWNATPFTOMPQ2PlatformDMPUPI1PNTXHVGGamersNANAConversion1P177/?',
    stump:'http://servedby.flashtalking.com',
    jsurl:'http://cdn.flashtalking.com/xre/343/3437300/2427166/js/j-3437300-2427166.js',
    file:'http://cdn.flashtalking.com/95498/2427166/index.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM:'http://cdn.flashtalking.com',
    statBaseURL:'http://stat.flashtalking.com/reportV3/ft.stat?124289693-3437300;2427166;',
    adVis:false ? 1 : 0,
    centreAd:true,
    mvt:true,
    segment:window.ftSegment_3437300||'',
    segmentList:window.ftSegmentList_3437300||[],
    ftlocal:'flashtalking/ftlocal.html',
    attachtobody:false,
    zIndex:77000,
    blockBrowsers:'ie10'.split(','),
    ...
    baggyFrameLimit:15,
    append:!!(window.ftImp3437300 && window.ftImp3437300.jsAppend),
    ...
    pageVisible: 'maybe',
    altimgborder: '0',
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m3437300')&&/^https:/.test(document.getElementById('ftscript_m3437300').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m3437300'),
    ...
    qsVars:[
        ['ftguid', 'ftGUID_3437300'],
        ['ftcfid', 'ftConfID_3437300'],
        ['fttime', 'ftTimestamp_3437300'],
        ['ftsection', 'ftSection_3437300'],
        ['ftcustom', 'ftCustom_3437300'],
        ['ft_id', 'ftId_3437300'],
        ['ftimpid','ftImp3437300', 'impID']
    ]
};
