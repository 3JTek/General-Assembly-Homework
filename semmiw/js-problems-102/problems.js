...
function daysBetween(date1, date2) {
  ...
  // console.log(parseFloat(date1))
  // console.log(Math.round((parseFloat(date2) - parseFloat(date1))/(1000*60*60*24)))
  // return Math.round((parseFloat(date2) - parseFloat(date1))/(1000*60*60*24))
